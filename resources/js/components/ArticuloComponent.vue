...
<div>
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <label class="control-label col-md-3">Numero Registro</label>
            <div class="input-icon right">
                    <input type="text" class="form-control" v-model="numero_registro" name="numero_registro">
            </div>
            ...
            <div class="input-icon right">
                    <input type="text" class="form-control" v-model="cantidad" name="cantidad">
            </div>

            <label class="control-label col-md-3">Categoria</label>
            <select class="form-control" v-model="categoria_id">
                <option  v-for="(item,index) in listar_categorias_dd" :key="index"
        ...
        <br>
        <button type="button" class="btn btn-success" @click="insertarArticulos()">Guardar</button>
        <br>

        <div class="text-center" v-if="this.validacionNumero==1">
            <h4 style="color:red;">Este número de registro ya existe</h4>
        </div>
            ...
            <tbody>
                ...
                <td>
                    <button type="button" class="btn btn-info"
                            ...
                            @click="datosMod(item.id, item.numero_registro, item.nombre, item.cantidad, item.categoria_id)">
                        Editar
                    </button>
                    <button type="button" class="btn btn-danger" @click="eliminarArticulo(item.id)">
                        Eliminar
                    </button>
                </td>
                </tr>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="ArticuloModalLabel">Editar Categoria</h5>
            ...
            <div class="modal-body">
                ...
                <div class="input-icon right">
                        <input type="text" class="form-control" v-model="mod_numero_registro" name="mod_numero_registro">
                </div>

                <label class="control-label col-md-3">Nombre</label>
                <div class="input-icon right">
                        <input type="text" class="form-control" v-model="mod_nombre" name="mod_nombre">
                </div>

                <label class="control-label col-md-3">Cantidad</label>
                <div class="input-icon right">
                        <input type="text" class="form-control" v-model="mod_cantidad" name="mod_cantidad">
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" @click="modificarArticulo()">Guardar</button>
            </div>
            </div>
        </div>
        </div>
        ...
        <div class="text-center">
            <a type="button" class="btn btn-success" href="excel"> Reporte </a>
        </div>
    </div>
</div>
</template>
...
export default {
    ...
    methods: {
        ...
        modificarArticulo(){
            ...
            axios.put(`articulomodificar/${this.mod_id}`, modificar).then(respuesta=>{location.reload()});
        },
        eliminarArticulo(id){
